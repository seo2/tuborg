							...
							<fieldset>
								...
								<div class="form-group first">
								  	<div class="input-group col-sm-12">
										...
										<input type="text" class="form-control input-lg" id="username" placeholder="E-mail usuario" name="email" required/>	
									</div>
								</div>
								...
								<div class="form-group last">
								  	<div class="input-group col-sm-12">
										...
										<input type="password" class="form-control input-lg" id="password" placeholder="Contraseña" name="pass" required/>
									</div>
								</div>

								<button type="submit" class="btn btn-primary col-xs-12" id="loginBtn">Ingresar</button>
